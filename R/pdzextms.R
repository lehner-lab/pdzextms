...
pdzextms <- function(
  ...
  pdzextms_thermo_model_results(
    ...
    position_offset = 311,
    outpath = pdzextms__format_dir(dir_suffix="_pdzextms_thermo_model_results_PSD95-PDZ3", stagenum=stagenum, base_dir=base_dir),
  ...
  pdzextms_thermo_model_results(
    ...
    literature_free_energies = file.path(base_dir, "Data", "in_vitro", "PDZ_literature_free_energies.txt"),
    position_offset = 311,
    outpath = pdzextms__format_dir(dir_suffix="_pdzextms_thermo_model_results_PSD95-PDZ3_N", stagenum=stagenum, base_dir=base_dir),
    colour_scheme = colour_scheme,
    execute = (first_stage <= stagenum & last_stage >= stagenum))
  ...
  pdzextms_thermo_model_results(
    ...
    literature_free_energies = file.path(base_dir, "Data", "in_vitro", "PDZ_literature_free_energies.txt"),
    position_offset = 311,
    outpath = pdzextms__format_dir(dir_suffix="_pdzextms_thermo_model_results_PSD95-PDZ3_C", stagenum=stagenum, base_dir=base_dir),
    colour_scheme = colour_scheme,
    execute = (first_stage <= stagenum & last_stage >= stagenum))
  ...
  pdzextms_thermo_model_results(
    ...
    literature_free_energies = file.path(base_dir, "Data", "in_vitro", "PDZ_literature_free_energies.txt"),
    position_offset = 311,
    outpath = pdzextms__format_dir(dir_suffix="_pdzextms_thermo_model_results_PSD95-PDZ3_NC", stagenum=stagenum, base_dir=base_dir),
    colour_scheme = colour_scheme,
    execute = (first_stage <= stagenum & last_stage >= stagenum))
  ...
  pdzextms_structure_metrics(
    ...
    outpath = pdzextms__format_dir(dir_suffix="_pdzextms_structure_metrics_PSD95-PDZ3", stagenum=stagenum, base_dir=base_dir),
  ...
  pdzextms_structure_metrics(
    ...
    outpath = pdzextms__format_dir(dir_suffix="_pdzextms_structure_metrics_PSD95-PDZ3_N", stagenum=stagenum, base_dir=base_dir),
    pdb_file = file.path(base_dir, "Data", "pdb", "1be9.pdb"),
    execute = (first_stage <= stagenum & last_stage >= stagenum))
  #PSD95-PDZ3 Cterm extension
  pdzextms_structure_metrics(
    input_file = file.path(base_dir, paste0("001", "_pdzextms_thermo_model_results_PSD95-PDZ3_C"), "dg_singles.txt"),
    outpath = pdzextms__format_dir(dir_suffix="_pdzextms_structure_metrics_PSD95-PDZ3_C", stagenum=stagenum, base_dir=base_dir),
    pdb_file = file.path(base_dir, "Data", "pdb", "1be9.pdb"),
    execute = (first_stage <= stagenum & last_stage >= stagenum))
  #PSD95-PDZ3 N and Cterm extension
  pdzextms_structure_metrics(
    input_file = file.path(base_dir, paste0("001", "_pdzextms_thermo_model_results_PSD95-PDZ3_NC"), "dg_singles.txt"),
    outpath = pdzextms__format_dir(dir_suffix="_pdzextms_structure_metrics_PSD95-PDZ3_NC", stagenum=stagenum, base_dir=base_dir),
    pdb_file = file.path(base_dir, "Data", "pdb", "1be9.pdb"),
    execute = (first_stage <= stagenum & last_stage >= stagenum))
  ...
  #   outpath = pdzextms__format_dir(dir_suffix="_pdzextms_fitness_plots", stagenum=stagenum, base_dir=base_dir),
  #   colour_scheme = colour_scheme,
  #   execute = (first_stage <= stagenum & last_stage >= stagenum))
  ...
  #   domain_name = "GB1",
  #   outpath = pdzextms__format_dir(dir_suffix="_pdzextms_fitness_heatmaps_GB1", stagenum=stagenum, base_dir=base_dir),
  #   colour_scheme = colour_scheme,
  #   plot_width = 11,
  #   plot_traits = "Binding",
  #   execute = (first_stage <= stagenum & last_stage >= stagenum))
  ...
  #   outpath = pdzextms__format_dir(dir_suffix="_pdzextms_fitness_heatmaps_PSD95-PDZ3", stagenum=stagenum, base_dir=base_dir),
  #   colour_scheme = colour_scheme,
  #   plot_width = 15,
  #   execute = (first_stage <= stagenum & last_stage >= stagenum))
  # #GRB2-SH3
  ...
  #   outpath = pdzextms__format_dir(dir_suffix="_pdzextms_fitness_heatmaps_GRB2-SH3", stagenum=stagenum, base_dir=base_dir),
  #   colour_scheme = colour_scheme,
  #   plot_width = 11,
  #   execute = (first_stage <= stagenum & last_stage >= stagenum))
  ...
  #   ),
  #   outpath = pdzextms__format_dir(dir_suffix="_pdzextms_free_energy_scatterplots", stagenum=stagenum, base_dir=base_dir),
  #   colour_scheme = colour_scheme,
  #   execute = (first_stage <= stagenum & last_stage >= stagenum))
  ...
  #   input_file = file.path(base_dir, paste0("002", "_pdzextms_structure_metrics_GB1"), "dg_singles.txt"),
  #   domain_name = "GB1",
  #   outpath = pdzextms__format_dir(dir_suffix="_pdzextms_free_energy_heatmaps_GB1", stagenum=stagenum, base_dir=base_dir),
  #   colour_scheme = colour_scheme,
  #   plot_width = 11,
  #   execute = (first_stage <= stagenum & last_stage >= stagenum))
  # #PSD95-PDZ3
  ...
  #   input_file = file.path(base_dir, paste0("002", "_pdzextms_structure_metrics_PSD95-PDZ3"), "dg_singles.txt"),
  #   domain_name = "PSD95 PDZ3",
  #   outpath = pdzextms__format_dir(dir_suffix="_pdzextms_free_energy_heatmaps_PSD95-PDZ3", stagenum=stagenum, base_dir=base_dir),
  #   colour_scheme = colour_scheme,
  #   plot_width = 15,
  #   execute = (first_stage <= stagenum & last_stage >= stagenum))
  # #GRB2-SH3
  ...
  #   input_file = file.path(base_dir, paste0("002", "_pdzextms_structure_metrics_GRB2-SH3"), "dg_singles.txt"),
  #   domain_name = "GRB2 SH3",
  #   outpath = pdzextms__format_dir(dir_suffix="_pdzextms_free_energy_heatmaps_GRB2-SH3", stagenum=stagenum, base_dir=base_dir),
  #   colour_scheme = colour_scheme,
  #   plot_width = 11,
  #   execute = (first_stage <= stagenum & last_stage >= stagenum))
