...
#' pdzextms__create_dir
#'
#' Create results folder for analysis script plots and saved objects.
#'
#' @param pdzextms_dir directory path string (required)
...
pdzextms__create_dir <- function(
  ...
  if(dir.exists(pdzextms_dir) & overwrite_dir){
    unlink(pdzextms_dir, recursive = TRUE)
  }
  dir.create(pdzextms_dir, showWarnings = FALSE)
  return(pdzextms_dir)
}
