...
#' @export
#' @import data.table
pdzextms_structure_metrics <- function(
  input_file,
  outpath,
  pdb_file,
  pdb_chain_query = "A",
  ...
  #Display status
  message(paste("\n\n*******", paste("running stage: pdzextms_structure_metrics for", basename(pdb_file)), "*******\n\n"))
  ...
  dist_dt <- pdzextms__minimum_interchain_distances_from_PDB(
